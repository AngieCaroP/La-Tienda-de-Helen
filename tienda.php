...
if(!$connection) 
        ...
        $instruccion_SQL = "INSERT INTO tabla_tienda (nombre, email, celular, usuario, contraseña)
                             VALUES ('$nombre','$email','$celular','$usuario','$contraseña')";
                           
                            
        $resultado = mysqli_query($connection,$instruccion_SQL);

        //$consulta = "SELECT * FROM tabla where id ='2'"; si queremos que nos muestre solo un registro en especifivo de ID
        $consulta = "SELECT * FROM tabla_tienda";
